<x-app-layout>
    <x-slot name="header">
        <div class="flex">
            <a href="{{ route('admin.users.index') }}" class="inline-flex justify-center items-center mr-2">
            ...
            <form method="post" action="{{ route('admin.users.store') }}">
                ...
                <div class="flex flex-col md:flex-row md:space-x-4">
                    <div>
                        ...
                        <x-text-input id="lastname" class="block mt-1" type="text" name="lastname"
                ...
                <div class="flex flex-col mt-4">
                    ...
                    <x-text-input id="email" class="block mt-1" type="email" name="email" :value="old('email')"
                        required />
